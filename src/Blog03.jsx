...
import blog01 from "./assets/blog01.png";      // <- fixed path
import blog0001 from "./assets/blog0001.png";  // <- fixed path
import Navbar from "./components/Navbar";

/* Duplicate of Blog01 but as Blog02 — images unch
anged. */
    ...
    <div className="min-h-screen">
      ...
      <aside className="w-1/4 fixed left-0 top-0 h-screen bg-black p-6 border-r border-gray-800 z-40 text-white">
        ...
        <div>
          ...
          <a
            href="https://www.linkedin.com/sharing/share-offsite/?url=https://lyric.tech/blog/tariffs-trade-wars-and-the-ai-advantage-why-fast-modeling-wins"
            target="_blank"
